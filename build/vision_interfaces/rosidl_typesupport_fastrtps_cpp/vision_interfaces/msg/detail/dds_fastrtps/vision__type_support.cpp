...
#include "vision_interfaces/msg/detail/vision__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vision_interfaces::msg::Vision & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_interfaces::msg::Vision & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vision_interfaces::msg::Vision;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_interfaces::msg::Vision *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_interfaces::msg::Vision *>(
    untyped_ros_message);
...
{
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_Vision__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interfaces, msg, Vision)() {
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_Vision__handle;
}
